...
export {
    ...
    #####################################  BVLC Result Codes  #####################################
    ###############################################################################################
    const bvlc_results: table[count] of string = {
    ...
    #######################################  Abort Reasons  #######################################
    ###############################################################################################
    const abort_reasons: table[count] of string = {
        [0] = "other",
        [1] = "buffer-overflow",
    ...
    ######################################  Reject Reasons  #######################################
    ###############################################################################################
    const reject_reasons: table[count] of string = {
        [0] = "other",
        [1] = "buffer-overflow",
    ...
    ########################################  Error Codes  ########################################
    ###############################################################################################
    const error_codes: table[count] of string = {
        [0] = "other",
    ...
    ###############################################################################################
    const unconfirmed_service_choice: table[count] of string = {
        [0] = "i_am",
        [1] = "i_have",
    ...
    ###############################################################################################
    const property_identifiers: table[count] of string = {
        [0] = "acked-transition",
        [1] = "ack-required",
        [2] = "action",
        [3] = "action-text",
    ...
    ########################################  Event State  ########################################
    ###############################################################################################
    const event_states: table[count] of string = {
        [0] = "normal",
        [1] = "fault",
        [2] = "offnormal",
        [3] = "high-limit",
    ...
    #######################################  Device Status  #######################################
    ###############################################################################################
    const device_status: table[count] of string = {
        [0] = "operational",
    ...
    ###############################################################################################
    const segmentation_supported_status: table[count] of string = {
        [0] = "segmented-both",
    ...
    #######################################  Logging Type  ########################################
    ###############################################################################################
    const logging_type: table[count] of string = {
        [0] = "polled",
        [1] = "cov",
        [2] = "triggered",
    } &default = function(n: count): string {return fmt("Vendor Specific (%d)", n); };
    ...
    ########################################  Reliability  ########################################
    ###############################################################################################
    const reliability: table[count] of string = {
        [0] = "no-fault-detected",
        [1] = "no-sensor",
        [2] = "over-range",
        [3] = "under-range",
    ...
    #######################################  Notify Type  ########################################
    ###############################################################################################
    const notify_type: table[count] of string = {
        [0] = "alarm",
        [1] = "event",
        [2] = "ack-notification",
    } &default = function(n: count): string {return fmt("Vendor Specific (%d)", n); };
    ...
    ####################################  BACnet Object Types  ####################################
    ###############################################################################################
    const object_types: table[count] of string = {
        [0] = "analog-input",
        [1] = "analog-output",
        [2] = "analog-value",
        [3] = "binary-input",
    ...
    ####################################  BACnet Vendor Codes  ####################################
    ###############################################################################################
    const vendors: table[count] of string = {
        [0] = "ASHRAE",
        [1] = "NIST",
        [2] = "The Trane Company",
    ...
    const bacnet_units: table[count] of string = {
        [0] = "square-meters",
        [1] = "square-feet",
        [2] = "milliamperes",
        [3] = "amperes",
